// ============================================================
// /api/annotate — Luồng Gemini: phân tích lỗi diễn đạt
// ============================================================
...
3. Câu quá dài (trên 50 từ) mà không có dấu ngắt câu nào — gây khó đọc

QUY TẮC:
- Ưu tiên các lỗi loại 1 và 2 trước. Loại 3 chỉ flag khi câu thực sự rất dài.
